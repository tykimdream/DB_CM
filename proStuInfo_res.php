...
<body onload="startTime()">
    ...
    <span class="returnButton" type="button" onclick="location.href='proStuInfo.php'"><i class="fas fa-school"></i> 돌아가기 </span>
    ...
    <div class="proResult">
        <h2>검색하신 교수님 성함 : <?php echo $_POST["id"]; ?></h2>
    </div>

    <form class="searchForm" action="proStuInfo_res.php" method="post">
        교수 검색 &nbsp; <input type="text" name="id" placeholder="교수님 성함을 입력해주세요">
    ...
    <div class="tableDiv">
        <table>
            ...
            <?
            $connect = mysqli_connect("localhost", "root", "1234");  // Mysql 접속
            mysqli_select_db($connect, "cm"); // 해당 DB로 이동
